...
Statefull components tend to create or interact/change state.
Functional components use thing that once created cannot be changed with state.

2. When does a componentWillMount function be called? What about a componentWillUpdate?

componentWillMount is like a useEffect with an empty array it will run whenever the mage reloads/remounts.
componentWillUpdate is like a useEffect without an array it will run whenever something changes.

3. Define stateful logic.

Statefull logic is code that can change depending on what happens on the page, like a function for clicking a button or a function for a text input.

4. What are the three step of creating a successful test? What is done in each phase?
   Arrange: usually means to render the component you want to test
   Act: Inputing and simulating what a user might do
   Assert: Telling the computer what is supposed to happed after the inputs or to see if something exists.
